...
function Convert-CVSS4StringToBaseScore {
    ...
    $impactLookup = @{
        ...
        '0-1' = 5.6  # High vulnerable, low subsequent
        '0-2' = 6.1  # High vulnerable, no subsequent
        '1-0' = 1.8  # Low vulnerable, high subsequent
        '1-1' = 3.0  # Low vulnerable, low subsequent
        '1-2' = 4.5  # Low vulnerable, no subsequent
        '2-0' = 3.5  # No vulnerable, high subsequent
